...
- Windows Release ZIP에는 GUI exe, CLI exe, 한국어 문서, Role 대역 예제 Excel, mock scenario JSON이 포함됩니다.
- GitHub Actions는 PR에서 테스트/Windows 빌드/ZIP 검증을 수행하고, main push에서 공개 Release와 SHA256 파일을 생성합니다.
