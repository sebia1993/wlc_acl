...
GitHub Release에는 아래 네 파일을 업로드합니다.
...
Windows GUI/CLI ZIP 내부에는 아래 파일이 포함되어야 합니다.
...
Streamlit portable ZIP 내부에는 아래 파일이 포함되어야 합니다.
...
Streamlit 웹앱은 Windows EXE ZIP과 별도의 portable ZIP으로 배포합니다. 일반 사용자는 Python을 설치하지 않고 `start_webapp.cmd`를 더블클릭합니다.
